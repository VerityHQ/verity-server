...
public class CommunityApiTest {
    ...
    public void createCommunityTest() throws ApiException {
        Community body = null;
        // Community response = api.createCommunity(body);
    ...
    public void getCommunityTest() throws ApiException {
        String uuid = null;
        // Community response = api.getCommunity(uuid);
     ...
     */
    @Test
    public void updateCommunityTest() throws ApiException {
        Community body = null;
        // api.updateCommunity(body);
