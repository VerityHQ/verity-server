...
public class OrganizationApi {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getOrganizationValidateBeforeCall(String uuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Organization> getOrganizationWithHttpInfo(String uuid) throws ApiException {
        com.squareup.okhttp.Call call = getOrganizationValidateBeforeCall(uuid, null, null);
        Type localVarReturnType = new TypeToken<Organization>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call getOrganizationAsync(String uuid, final ApiCallback<Organization> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getOrganizationValidateBeforeCall(uuid, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Organization>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for getOrganizationCommunities */
    private com.squareup.okhttp.Call getOrganizationCommunitiesCall(String uuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/organization/{uuid}/community".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "uuid" + "\\}", apiClient.escapeString(uuid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getOrganizationCommunitiesValidateBeforeCall(String uuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'uuid' is set
        if (uuid == null) {
            throw new ApiException("Missing the required parameter 'uuid' when calling getOrganizationCommunities(Async)");
        }
        
        
        com.squareup.okhttp.Call call = getOrganizationCommunitiesCall(uuid, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * get organization communities
     * 
     * @param uuid  (required)
     * @return List&lt;Community&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Community> getOrganizationCommunities(String uuid) throws ApiException {
        ApiResponse<List<Community>> resp = getOrganizationCommunitiesWithHttpInfo(uuid);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Community>> getOrganizationCommunitiesWithHttpInfo(String uuid) throws ApiException {
        com.squareup.okhttp.Call call = getOrganizationCommunitiesValidateBeforeCall(uuid, null, null);
        Type localVarReturnType = new TypeToken<List<Community>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * get organization communities (asynchronously)
     * 
     * @param uuid  (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getOrganizationCommunitiesAsync(String uuid, final ApiCallback<List<Community>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getOrganizationCommunitiesValidateBeforeCall(uuid, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Community>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateOrganizationValidateBeforeCall(Organization body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> updateOrganizationWithHttpInfo(Organization body) throws ApiException {
        com.squareup.okhttp.Call call = updateOrganizationValidateBeforeCall(body, null, null);
    ...
    public com.squareup.okhttp.Call updateOrganizationAsync(Organization body, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateOrganizationValidateBeforeCall(body, progressListener, progressRequestListener);
