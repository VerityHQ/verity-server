...
import site.verity.client.auth.Authentication;
import site.verity.client.auth.HttpBasicAuth;
import site.verity.client.auth.ApiKeyAuth;
import site.verity.client.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "http://springserver.cfapps.io/verity/core";
    ...
    public ApiClient() {
        ...
        authentications.put("verity_auth_token", new ApiKeyAuth("query", "verity_auth_token"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://springserver.cfapps.io/verity/core
