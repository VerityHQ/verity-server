...
/**
 * ValueAction describes the action taken and the associated value (points)
 * awarded. Value can be retroactivly changed to adjust point distribution after
...
public class Valueaction implements Serializable {
	...
	/**
	 * Describes this action. Formatted as JSON or JSON:LD. Should include a
	 * short 'tag' and optionally a longer description or link to more content.
	 * 
	 * @return description
	 **/
	...
	/**
	 * the value awarded. Can be changed at any time. Changes to value will
	 * affect all transactions to date that have been created with this
	 * ValueAction.
	 * 
	 * @return value
	 **/
